...

{
  ...
  emit_file "evaluate-ai-llm.js" "$SCRIPT_DIR/evaluate-ai-llm.js" "EVALUATE_AI_LLM_HEREDOC_EOF"
  emit_file "eval.sh"            "$SCRIPT_DIR/eval.sh"            "EVAL_HEREDOC_EOF"

  cat << 'FOOTER'

chmod +x "$INSTALL_DIR/evaluate.sh" "$INSTALL_DIR/evaluate-ai-llm.js" "$INSTALL_DIR/eval.sh"
